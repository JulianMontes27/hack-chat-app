...
const Navbar = () => {
  ...
  const routes = [
    {
      label: "Coleccion",
      href: "/coleccion",
      isActive: pathname === "/coleccion",
    },

    {
      label: "Acerca",
      href: "/acerca",
      isActive: pathname === "/acerca",
    },
    {
      label: "Atelier",
      href: "/atelier",
      isActive: pathname === "/atelier",
    },
  ];
  ...
  return (
    <header
      className={cn(
        "fixed z-999 top-0 right-0 left-0 w-full p-3 bg-gray-900",
        scroll
          ? "stick shadow-xl transition border-pink-500/10 shadow-pink-500/10"
          : ""
      )}
    >
